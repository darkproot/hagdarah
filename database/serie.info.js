const SERIE = [
    ...
    {
        type: 'text',
        value: 'De meme, si une  <span class="italique">f est continue sur [a, b]</span>, alors f est <span class="italique">bornee sur [a, b]</span>.'
    },
    {
        name: 'Point adherent - adherence',
        definition: 'Soit <span class="italique">A C IR</span>. Un <span class="gras">point adherent</span> a A est tout nombre reels <span class="italique">x0</span> dont tout voisinage dans <span class="italique">IR</span> contient toujours (au moins) un element de A, ie verifiant:'
    },
    {
        type: 'equation',
    ...
    {
        type: 'text',
        value: 'L\' <span class="italique">adherence</span> de A est un <span class="italique">sous-ensemble</span> de IR, forme des nombres reels qui sont des points adherents a A.'
    },
    {
        name: 'Fonction bornee au voisinage dans A de x0',
        definition: 'Soient <span class="italique">A C IR</span> et un nombre reel <span class="italique">x0 appartenant a (A bar)</span>. Une fonction <span class="cadre">f : A --> IR</span> (ou C), est dite <span class="gras">bornee au voisinage de x0 dans A</span>, lorsque:'
    },
    {
        type: 'equation',
